...
try {
    ...
    # Acceptance authority: real installed UI, four target sizes, real-screen 1702 paint,
    # geometry/content checks and canonical tray lifecycle.
    ...
    # Separate fail-closed style verification for launcher bridge buttons.
