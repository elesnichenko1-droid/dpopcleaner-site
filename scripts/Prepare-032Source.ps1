...
Copy-Item (Join-Path $resolvedRoot 'v032/CMakeLists.txt') `
    (Join-Path $resolvedDestination 'CMakeLists.txt') -Force
Copy-Item (Join-Path $resolvedRoot 'v032/MainWindow.cpp') `
    (Join-Path $resolvedDestination 'src/app/MainWindow.cpp') -Force
Copy-Item (Join-Path $resolvedRoot 'v032/Version.h') `
    (Join-Path $resolvedDestination 'src/core/Version.h') -Force
Copy-Item (Join-Path $resolvedRoot 'v032/version.rc.in') `
    (Join-Path $resolvedDestination 'resources/version.rc.in') -Force
...
Write-Host "Prepared DPopCleaner 0.3.2 overlay at $resolvedDestination"
