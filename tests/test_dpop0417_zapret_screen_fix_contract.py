...
class DPop0417ZapretScreenFixContractTests(unittest.TestCase):
    def test_rev9_preserves_zapret_screen_fix_as_a_staged_shell_companion(self):
    ...
    def test_rev9_builds_and_tests_the_preserved_companion(self):
        ...
        self.assertIn('revision=9', workflow)
        self.assertIn('v0.4.17-rev9', workflow)

    def test_rev9_release_notes_and_site_disclose_preserved_screen_share_fix(self):
