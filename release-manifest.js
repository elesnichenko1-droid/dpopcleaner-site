(function(root, factory){
  ...
  const releaseUrl = /^https:\/\/github\.com\/elesnichenko1-droid\/dpopcleaner-site\/releases\/download\/v0\.4\.17-rev14\/DPopCleaner_Setup_0\.4\.17\.exe$/;
