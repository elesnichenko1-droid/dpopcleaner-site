...
#define MyAppVersion "0.3.4 BETA R1"
...
VersionInfoVersion=0.3.4.1
VersionInfoProductVersion=0.3.4.1
VersionInfoCompany=DPopCleaner Project
VersionInfoDescription=DPopCleaner 0.3.4 BETA R1 Setup
...
OutputDir=output
OutputBaseFilename=DPopCleaner_Setup_0.3.4_BETA_R1
SetupIconFile=..\dpopcleaner.ico
UninstallDisplayIcon={app}\DPopCleaner.exe
UninstallDisplayName=DPopCleaner 0.3.4 BETA R1
Compression=lzma2
